...
<div class="space-y-6">
	...
	<section class="cw-card">
		...
		<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
			<div>
				<label class="block text-secondary-text text-sm mb-1" for="char-name">
					Character Name
				</label>
				<input
					id="char-name"
			...
			<div>
				<label class="block text-secondary-text text-sm mb-1" for="char-alias">
					Street Name / Alias
				</label>
				<input
					id="char-alias"
	...
	{#if validationMessages.length > 0}
		<section class="cw-panel p-4 space-y-2">
			<h4 class="text-accent-primary font-medium mb-2">Validation</h4>
			{#each validationMessages as msg}
				<div
					class="flex items-start gap-2 text-sm
						{msg.type === 'error' ? 'text-accent-danger' : 'text-yellow-400'}"
				>
		...
		<div class="space-y-2 text-sm">
			{#if $bpBreakdown}
				<div class="flex justify-between py-1 border-b border-border/30">
					<span class="text-secondary-text">Metatype</span>
					<span class="text-primary-text font-mono">{$bpBreakdown.metatype} BP</span>
				</div>
				<div class="flex justify-between py-1 border-b border-border/30">
					<span class="text-secondary-text">Attributes</span>
					<span class="text-primary-text font-mono">{$bpBreakdown.attributes} BP</span>
				</div>
				<div class="flex justify-between py-1 border-b border-border/30">
					<span class="text-secondary-text">Skills</span>
					<span class="text-primary-text font-mono">{$bpBreakdown.skills} BP</span>
				</div>
				<div class="flex justify-between py-1 border-b border-border/30">
					<span class="text-secondary-text">Skill Groups</span>
					<span class="text-primary-text font-mono">{$bpBreakdown.skillGroups} BP</span>
				</div>
				<div class="flex justify-between py-1 border-b border-border/30">
					<span class="text-secondary-text">Qualities</span>
					<span class="text-primary-text font-mono">{$bpBreakdown.qualities} BP</span>
				</div>
				<div class="flex justify-between py-1 border-b border-border/30">
					<span class="text-secondary-text">Spells</span>
					<span class="text-primary-text font-mono">{$bpBreakdown.spells} BP</span>
				</div>
				<div class="flex justify-between py-1 border-b border-border/30">
					<span class="text-secondary-text">Complex Forms</span>
					<span class="text-primary-text font-mono">{$bpBreakdown.complexForms} BP</span>
				</div>
				<div class="flex justify-between py-1 border-b border-border/30">
					<span class="text-secondary-text">Contacts</span>
					<span class="text-primary-text font-mono">{$bpBreakdown.contacts} BP</span>
				</div>
				<div class="flex justify-between py-1 border-b border-border/30">
	...
	<section class="cw-card">
		...
		{#if $character}
			<div class="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
				<div>
					<span class="text-muted-text block">Metatype</span>
				...
				<div>
					<span class="text-muted-text block">Essence</span>
					<span class="text-accent-purple font-mono">{$currentEssence.toFixed(2)}</span>
				</div>
				<div>
					<span class="text-muted-text block">Nuyen</span>
					<span class="text-accent-cyan font-mono">{formatNuyen($remainingNuyen)}</span>
				</div>
				<div>
					<span class="text-muted-text block">Active Skills</span>
					<span class="text-primary-text">{$character.skills.length}</span>
				</div>
				<div>
					<span class="text-muted-text block">Qualities</span>
					<span class="text-primary-text">{$character.qualities.length}</span>
				</div>
				<div>
					<span class="text-muted-text block">Contacts</span>
					<span class="text-primary-text">{$character.contacts.length}</span>
				</div>
				<div>
					<span class="text-muted-text block">Weapons</span>
					<span class="text-primary-text">{$character.equipment.weapons.length}</span>
				</div>
				<div>
					<span class="text-muted-text block">Armor</span>
					<span class="text-primary-text">{$character.equipment.armor.length}</span>
				</div>
				<div>
			...
			{#if $character.qualities.length > 0}
				<div class="mt-4 pt-4 border-t border-border/30">
					<span class="text-muted-text text-sm block mb-2">Qualities:</span>
			...
			{#if $character.magic}
				<div class="mt-4 pt-4 border-t border-border/30">
					<span class="text-muted-text text-sm block mb-2">Magic:</span>
					<div class="text-sm">
						...
						{#if $character.magic.spells.length > 0}
							...
							<span class="text-primary-text ml-2">{$character.magic.spells.length}</span>
						{/if}
			...
			{#if $character.equipment.lifestyle}
				<div class="mt-4 pt-4 border-t border-border/30">
					<span class="text-muted-text text-sm block mb-2">Lifestyle:</span>
	...
	<div class="cw-panel p-4 text-sm">
		<h4 class="text-accent-primary mb-2">Finalization Tips</h4>
